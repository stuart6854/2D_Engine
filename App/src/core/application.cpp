...
static void SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR surface, int width, int height)
{
    ...
    ImGui_ImplVulkanH_CreateOrResizeWindow(
        g_Instance, g_PhysicalDevice, g_Device, wd, g_QueueFamily, nullptr, width, height, g_MinImageCount);
}
...
namespace app::core
{
        ...
        while (!glfwWindowShouldClose(m_windowHandle) && m_isRunning)
        {
            ...
            if (g_SwapChainRebuild)
            {
                ...
                if (width > 0 && height > 0)
                {
                    ...
                    ImGui_ImplVulkanH_CreateOrResizeWindow(
                        g_Instance, g_PhysicalDevice, g_Device, &g_MainWindowData, g_QueueFamily, nullptr, width, height, g_MinImageCount);
    ...
    auto Application::get_physical_device() -> VkPhysicalDevice
    {
        return g_PhysicalDevice;
    }

    auto Application::get_device() -> VkDevice
    {
        return g_Device;
    }
